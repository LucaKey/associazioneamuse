(function($) {
    ...
    $documentOn.ready( function() {
      ...
      // IFRAME popup (YouTube/Vimeo ecc.)
      ...
      // INLINE popup (MP4 interno nel sito)
      // Richiede HTML tipo: <a href="#amuseVideoModal" class="video-inline">...</a>
      // e <video id="amuseVideo"><source src="assets/video/amuse-showreel.mp4"></video>
      $(".video-inline").magnificPopup({
        type: "inline",
        midClick: true,
        mainClass: "mfp-fade",
        removalDelay: 160,
        callbacks: {
          open: function () {
            const v = document.getElementById("amuseVideo");
            if (v) {
              try {
                v.currentTime = 0;
              } catch (e) {}
